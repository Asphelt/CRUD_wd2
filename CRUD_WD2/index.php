...
<body id="html">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if($_POST["accion"]==2){
            ...
            $create = "insert into cars (model,brand,year) values
            ('$car_model','$car_brand','$car_year')";
            $result = mysqli_query($conn, $create);
            if ($result) {
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <h3 class="margin">Cars Crud</h3>
                <div class="panel panel-default panel-table">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col col-xs-6">
                                <h3 class="panel-title">Cars Database</h3>
                            </div>
                            <div class="col col-xs-6 text-right">
                                <button type="button" class="btn btn-success" data-toggle="modal"
                                    data-target="#modal_car_create" data-whatever="@fat">Create</button>
                                <div class="modal fade" id="modal_car_create" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-left d-inline" id="exampleModalLabel">Create New Car
                                                    <button type="button" class="close d-inline"
                                                        data-dismiss="modal">&times;</button>
                                                </h5>
                                            </div>
                        ...
                        <table class="table table-bordered table-hover table-dark">
                            ...
                            <tbody>
                                ...
                                while ($car_data = mysqli_fetch_array($result)) {
                                    echo "<tr>";
                                    echo "<td>" . $car_data['id'] . "</td>";
                                    echo "<td>" . $car_data['model'] . "</td>";
                                    echo "<td>" . $car_data['brand'] . "</td>";
                                    echo "<td>" . $car_data['year'] . "</td>";
                                    echo "<td><button type='button' class='btn btn-success' data-toggle='modal' data-target='#updateModal' onclick='actualizar_auto(" .$car_data['id'] . ")'>Update</button>
                                    <a href='delete.php?id=" . $car_data['id'] . "&accion=2'><button type='button' class='btn btn-danger'>Delete</button></a></td></tr>";
